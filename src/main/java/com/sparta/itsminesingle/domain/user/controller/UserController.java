...
/*        if (jwtUtil.validateToken(refreshToken)) {
    ...
    @GetMapping("/mysql/token")
    public ResponseEntity<String> selectRefreshToken(@RequestParam String username){
        return userService.tokenSelect(username);
    }

    @GetMapping("/redis/token")
    public ResponseEntity<String> getRefreshToken(@RequestParam String username){
        return userService.tokenRedisGet(username);
    }
