...
public class S3ImageService {
    ...
    public String upload(MultipartFile image) {
        if(image.isEmpty() || Objects.isNull(image.getOriginalFilename())){
            throw new IllegalArgumentException("아무 이미지도 올리지 않았습니다");
        }
    ...
    private String uploadImage(MultipartFile image) {
        ...
        try {
            ...
            throw new RuntimeException("이미지를 업로드하는데 오류가 발생했습니다");
        }
    }
    ...
    private String uploadImageToS3(MultipartFile image) throws IOException {
        ...
        try{
            ...
            throw new IOException("이미지가 아닙니다");
        }finally {
    ...
    public void deleteImageFromS3(String imageAddress) throws IOException{
        ...
        try{
            ...
            throw new IOException("이미지 삭제 중 오류가 발생하였습니다");
        }
    }
